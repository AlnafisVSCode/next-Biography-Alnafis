	...
	return (
		<div className="h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl">
			...
			<div className="hidden md:flex gap-4 w-1/3 justify-end">
				...
				{/* Linkedin */}
				<a
					href="https://www.linkedin.com/in/alnafis"
					className="group flex justify-center p-2 rounded-md drop-shadow-xl bg-gradient-to-r from-blue-500 to-blue-700 text-white font-semibold hover:translate-y-3 transition-all duration-500 hover:from-blue-700 hover:to-blue-900">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						width="1em"
						height="1.1em"
				...
				{/* Instagram */}
				<a
					href="https://www.instagram.com/alnafisxhunterxx"
					className="group flex justify-center p-2 rounded-md drop-shadow-xl bg-gradient-to-r from-purple-500 to-purple-700 text-white font-semibold hover:translate-y-3 transition-all duration-500 hover:from-purple-700 hover:to-purple-900">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						width="1em"
						height="1.2em"
